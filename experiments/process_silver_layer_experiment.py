...
def run_silver_layer_experiment(
    ...
    spark_builder = (
        ...
        .appName(f"SilverLayer-{experiment_name}")
    ...
    try:
        ...
        for table in ingestion_order:
            ...
            # Apply referential integrity for transactions
            ...
            logger.info(f"{table} transformation time: {table_transform_time:.2f}s")
            ...
            # Write with optional compression and partitioning 
            ...
            if enable_partitioning and table == "products" and partition_column in df.columns:
